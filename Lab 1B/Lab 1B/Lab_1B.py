...
while again == "y":
    ...
    again = input("Would you like to check another room? [y/n]: ")
    #use .lower() to clean it up so that there aren't a bunch of and statements
    again = again.lower()
   
   #put in while loop to ensure user again with either "y" or"n"
